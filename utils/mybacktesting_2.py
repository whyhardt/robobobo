...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_env', type=str, default='../stock_data/portfolio_custom140_2008_2022_max_range.csv',
    ...
    for file in os.listdir(args.data):
        if file.endswith('.csv'):
            ...
            df = pd.read_csv(os.path.join(args.data, file), index_col=0, header=0)[index_start:]
        ...
        for time in range(len(actions)):
            ...
            for i, file in enumerate(os.listdir(args.data)):
                ...
                class MyStrategy(Strategy):
                    t = time
                    observation_length = env_data.shape[0] - amounts.shape[0]
                    ...
                    def init(self):
                        ...
                        # print('----------------------------------------------------\n')
                        self.amounts = np.concatenate((np.zeros(self.observation_length), self.amounts))
